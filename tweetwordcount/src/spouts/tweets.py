...
# Vincent Chu
# File name  : tweets.py
# Description: Script to serve as the spout of the Streamparse project that
#              connects to the Twitter application, pulls tweets from the 
#              Twitter stream and emits the tweets to the parse bolt.
# Date       : 11/18/2016
############################################################################
...
################################################################################
twitter_credentials = {
    "consumer_key"        :  "KRCKuBDRJwJPZhLrEkzbXTgFk",
    "consumer_secret"     :  "PcRSg4RcUBF22xZrYfCmaJWoUOmHruEVFzaTpFpsOF4qMis9Eb",
    "access_token"        :  "799143178783727616-By3dbsEc1cktT2Nb7YhgoPPrFEwEV9Q",
    "access_token_secret" :  "7kl1XWMnLoTcwcnHgKgDQ9CpwNjNuxrtPgJzn5Yb7q09S",
}
